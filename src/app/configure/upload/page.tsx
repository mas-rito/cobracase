...
const Page = () => {
  ...
  return (
    <div
      className={cn(
        "relative my-6 flex h-full min-h-72 w-full flex-1 flex-col items-center justify-center rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl",
        {
